...
export const upstreamRepositories = sqliteTable("upstream_repositories", {
  ...
  issuesEnabled: integer("issues_enabled", { mode: "boolean" }),
  openPrs: integer("open_prs"),
  totalPrs: integer("total_prs"),
  pullRequestsEnabled: integer("pull_requests_enabled", { mode: "boolean" }),
  ...
  latestTagName: text("latest_tag_name"),
  latestTagPublishedAt: text("latest_tag_published_at"),
  latestTagUrl: text("latest_tag_url"),
